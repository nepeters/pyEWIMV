...
% path to files
pname = 'D:\UVA\Research\AM_316L\XRD\Vertical_BDright\Cr Tube';

% which files to be imported
fname = {...
  [pname '\110_pf_316L_vert.xrdml'],...
  [pname '\200_pf_316L_vert.xrdml'],...
  [pname '\211_pf_316L_vert.xrdml'],...
  };

% background
pname = 'D:\UVA\Research\AM_316L\XRD\Vertical_BDright\Cr Tube';
fname_bg = {...
  [pname '\Bkgd_73_316L_vert.xrdml'],...
  [pname '\Bkgd_100_316L_vert.xrdml'],...
  [pname '\Bkgd_100_316L_vert2.xrdml'],...
  };
